...
class CuidadoScreen extends StatefulWidget {
  const CuidadoScreen({Key? key}) : super(key: key);

  @override
  _CuidadoScreenState createState() => _CuidadoScreenState();
}

class _CuidadoScreenState extends State<CuidadoScreen> {
